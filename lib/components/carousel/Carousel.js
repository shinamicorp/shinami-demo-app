...
class Carousel extends Component {
    ...
    render() {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement("div", { style: { position: 'relative', width: '100%', height: '100%' } }, this.getPresentableSlides().map((slide, presentableIndex) => (React.createElement(CarouselSlide, { key: slide.key, content: slide.content, currentIndex: slide.index, onClick: slide.onClick, currentSlide: goToSlide, offsetRadius: this.clampOffsetRadius(offsetRadius), index: presentableIndex, animationConfig: animationConfig }))))));
    }
}
